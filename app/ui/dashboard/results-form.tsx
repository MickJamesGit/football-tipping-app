...
import { saveGameResults } from "./../../lib/actions";
        ...
        <tbody>
          {unresultedGames.map((game) => (
            <tr key={game.id}>
              ...
              <td className="px-4 py-2 border-b">{game.home_team_name}</td>
              <td className="px-4 py-2 border-b">{game.away_team_name}</td>
              <td className="px-4 py-2 border-b">
                <input
                  type="number"
